...
func taskQueueTaskRestart(logger slog.Logger, store taskstore.StoreInterface) *taskQueueTaskRestartController {
	return &taskQueueTaskRestartController{
		logger: logger,
		store:  store,
	}
}

type taskQueueTaskRestartController struct {
	logger slog.Logger
	store  taskstore.StoreInterface
}

func (c *taskQueueTaskRestartController) ToTag(w http.ResponseWriter, r *http.Request) hb.TagInterface {
...
func (c *taskQueueTaskRestartController) modal(data taskQueueTaskRestartControllerData) *hb.Tag {
...
type taskQueueTaskRestartControllerData struct {
